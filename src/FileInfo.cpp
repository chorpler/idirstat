 ...
 *   Summary:	Support classes for iDirStat
...
QString iDirStat::formatSize( FileSize lSize )
{
    QString sizeString;
    int	    unitIndex = 0;
...
QString iDirStat::formatTime( time_t rawTime )
{
    if ( rawTime == (time_t) 0 )
	return "";
...
QString iDirStat::baseName( const QString & fileName )
{

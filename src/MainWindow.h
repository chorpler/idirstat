...
using iDirStat::FileInfo;
using iDirStat::FileTypeStatsWindow;
...
public:
     ...
     **/
    iDirStat::DirTreeModel * dirTreeModel() const { return _dirTreeModel; }

public slots:

    /**
     * Launch a new window to read a new location
     **/
    void spawnNewWindow();
...
private:
    ...
    Ui::MainWindow		* _ui;
    iDirStat::DirTreeModel	* _dirTreeModel;
    iDirStat::SelectionModel	* _selectionModel;
    iDirStat::CleanupCollection * _cleanupCollection;
    iDirStat::MimeCategorizer	* _mimeCategorizer;
    iDirStat::ConfigDialog	* _configDialog;
